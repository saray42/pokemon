...
import sarah.thurnwald.logic.calculator.CatchCalculator;
...
class CatchCalculatorTest {

    CatchCalculator catchCalculator = new CatchCalculator();
    ...
    @Test
    void calculateCatchRate() {
        assertEquals(25.f, catchCalculator.calculateCatchRate(wildPokemon, Pokeball.POKEBALL));
    }
}